...
c       thesis      
     ...
     *        topcg0mig(ix,iy)
     ...
     +  buf)                  !pointer
      ...
      save topc0,topc1,topcg0,topcg1

      real alphamin,alphamax
      save alphamin,alphamax
      ...
      save nxrt
      save nyrt
      save nxrtbeg,nxrtend
      save nyrtbeg,nyrtend
      save ixdisp,iydisp
      save iseed0,iseed1 
      save nsort 
      save sort1,sort2
      ...
      save size_topz0grid
      save size_topz1grid
      save size_basez0grid
      save size_basez1grid
      save size_cupdate
      save size_ctrc0mig
      save size_zupdate
      save size_tmisfit0
